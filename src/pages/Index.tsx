...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
          ...
          <nav className="hidden md:flex space-x-6 items-center">
            ...
            {student ? (
              <div className="flex items-center space-x-3">
                ...
                >
                  {student.profile_completed ? "Dashboard" : "Complete Profile"}
                </Button>
                <Button
                  variant="outline"
        ...
        <div className="max-w-4xl mx-auto">
          <div className="animate-fade-in">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-navy-800 mb-6 leading-tight animate-fade-in">
              Meet
              <span className="bg-gradient-to-r from-navy-600 to-autumn-500 bg-clip-text text-transparent">
                {" "}
                Zane AI
              </span>
            </h1>
            ...
            <p className="text-xl text-navy-600 font-medium mb-4 animate-fade-in">
              Smart Career Mapping for Healthcare Professionals
            </p>

            <p className="text-lg text-slate-600 mb-12 max-w-2xl mx-auto leading-relaxed animate-fade-in">
              Your intelligent career co-pilot that analyzes your healthcare
              background, maps perfect career paths, and guides you to success
              in clinical roles and allied health opportunities.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 animate-fade-in">
              ...
              <Button
                variant="outline"
                size="lg"
                className="border-2 border-navy-200 text-navy-700 hover:bg-navy-50 px-8 py-4 text-lg rounded-xl transition-all duration-300"
              >
                Watch Demo
              </Button>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-navy-800 mb-4">
              Complete Career Intelligence in 7 Steps
            </h2>
            <p className="text-xl text-slate-600">
              Comprehensive healthcare career transformation
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            {[
              ...
              <Card
                key={index}
                className="bg-white border border-slate-200 hover:border-navy-300 transition-all duration-300 group hover:shadow-lg rounded-xl"
              >
                <CardHeader className="text-center pb-3">
                  <div
                    className={`w-14 h-14 bg-gradient-to-r ${item.color} rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                  >
                    <item.icon className="w-7 h-7 text-white" />
                  </div>
                  <div className="text-xs font-bold text-autumn-600 mb-2 tracking-wider">
                    STEP {item.step}
                  </div>
                  <CardTitle className="text-navy-800 text-lg font-semibold">
                    {item.title}
                  </CardTitle>
                </CardHeader>
      ...
      <section id="features" className="bg-slate-50 py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600">
              Everything you need for healthcare career success
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-white/90 mb-8">
              Join thousands of healthcare graduates who've accelerated their
              career success with Zane AI
            </p>
            <Button
              onClick={handleGetStarted}
              size="lg"
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-slate-500 text-sm">
              © 2024 ZaneProEd. Transforming healthcare careers with
              intelligence.
            </div>
          </div>
        </div>
      ...
      {/* Sign In Modal */}
      {showSignInModal && (
        <SignIn isModal={true} onClose={() => setShowSignInModal(false)} />
      )}
    </div>
  );
};
